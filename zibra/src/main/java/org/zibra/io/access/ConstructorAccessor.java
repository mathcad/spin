...
public class ConstructorAccessor {
    ...
    static {
        ...
        Method _newInstance;
        try {
            _newInstance = ObjectStreamClass.class.getDeclaredMethod("newInstance");
    ...
    public static <T> T newInstance(Class<T> type) throws ZibraException {
        ...
        try {
            ...
            throw new ZibraException(ex.getMessage());
        }
    }
}
