...
public final class ValueReader {
    ...
    @SuppressWarnings({"fallthrough"})
    public static long readLong(Reader reader, int tag) throws IOException {
        InputStream stream = reader.stream;
        long result = 0;
        int i = stream.read();
        if (i == tag) {
    ...
    @SuppressWarnings({"fallthrough"})
    public static float readLongAsFloat(Reader reader) throws IOException {
        InputStream stream = reader.stream;
        float result = 0.0F;
        int i = stream.read();
        if (i == TagSemicolon) {
    ...
    @SuppressWarnings({"fallthrough"})
    public static double readLongAsDouble(Reader reader) throws IOException {
        InputStream stream = reader.stream;
        double result = 0.0;
        int i = stream.read();
        if (i == TagSemicolon) {
    ...
    public static float parseFloat(StringBuilder value) {
        try {
    ...
    public static double parseDouble(StringBuilder value) {
        try {
    ...
    public static int readLength(Reader reader) throws IOException {
        return readInt(reader, TagQuote);
    }

    public static int readCount(Reader reader) throws IOException {
        return readInt(reader, TagOpenbrace);
    }

    public static StringBuilder readUntil(Reader reader, int tag) throws IOException {
        InputStream stream = reader.stream;
    ...
    public static BigInteger readBigInteger(Reader reader) throws IOException {
    ...
    public static float readFloatInfinity(Reader reader) throws IOException {
        return (reader.stream.read() == TagNeg) ? Float.NEGATIVE_INFINITY : Float.POSITIVE_INFINITY;
    }

    public static double readInfinity(Reader reader) throws IOException {
    ...
    public static String readUTF8Char(Reader reader) throws IOException {
    ...
    public static int readTime(Reader reader, DateTime dt) throws IOException {
        InputStream stream = reader.stream;
    ...
    public static UUID readUUID(Reader reader) throws IOException {
        ...
        return UUID.fromString(new String(buf));
    }
