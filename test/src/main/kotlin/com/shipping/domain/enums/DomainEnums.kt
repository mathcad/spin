 ...
 */
@UserEnum("系统功能类型")
enum class FunctionTypeE(private val value: Int, val desc: String) : Evaluatable<Int> {
 ...
 */
@UserEnum("组织机构类型")
enum class OrganizationTypeE(private val value: Int, val desc: String) : Evaluatable<Int> {
 ...
 */
@UserEnum("区域类型")
enum class RegionTypeE(private val value: Int, val desc: String) : Evaluatable<Int> {
 ...
 */
@UserEnum("用户类型")
enum class UserTypeE(private val value: Int) : Evaluatable<Int> {
    普通用户(2), 微信用户(3);
