...
class ChineseToPinyinResource {
    ...
    private void initializeResource() {
        ...
        try (BufferedInputStream pinyinRes = ResourceHelper.getResourceInputStream(resourceName); BufferedInputStream multipinyinRes = ResourceHelper.getResourceInputStream(resourceMultiName)) {
            setUnicodeToHanyuPinyinTable(new Trie());
            getUnicodeToHanyuPinyinTable().load(pinyinRes);
            getUnicodeToHanyuPinyinTable().loadMultiPinyin(multipinyinRes);
