...
class FeignClientFactoryBean
    ...
    private void configureFeign(FeignContext context, Feign.Builder builder) {
    ...
    private void configureUsingConfiguration(FeignContext context,
    ...
    private <T> T getOptional(FeignContext context, Class<T> type) {
    ...
    public String toString() {
        return "FeignClientFactoryBean{" + "type=" +
            this.type + ", " + "name='" +
            this.name + "', " + "url='" +
            this.url + "', " + "path='" +
            this.path + "', " + "decode404=" +
            this.decode404 + ", " + "applicationContext=" +
            this.applicationContext + ", " + "fallback=" +
            this.fallback + ", " + "fallbackFactory=" +
