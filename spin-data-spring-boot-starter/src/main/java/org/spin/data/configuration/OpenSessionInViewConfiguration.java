...
import org.spin.data.provider.DefaultSessionFactoryProvider;
import org.spin.data.provider.SessionFactoryProvider;
import org.spin.data.provider.WebSessionFactoryProvider;
import org.spin.data.interceptor.OpenSessionInViewInterceptor;
 ...
 * @version 1.0
 */
@AutoConfigureAfter(name = {"org.spin.data.configuration.DataSourceAutoConfiguration"})
