...
//		this.response = response;
	...
	* @version 1.0
	 */
	public String getRequestURL(TenpayConfig cfg) throws UnsupportedEncodingException {
		
		this.createSign(cfg);
		
		StringBuffer sb = new StringBuffer();
		String enc = cfg.input_charset;
	 ...
	 */
	protected void createSign(TenpayConfig cfg) {
		StringBuffer sb = new StringBuffer();
		Set<Entry<String, String>> es = this.parameters.entrySet();
		Iterator<Entry<String, String>> it = es.iterator();
		while(it.hasNext()) {
