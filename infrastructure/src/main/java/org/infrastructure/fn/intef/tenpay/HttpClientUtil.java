...
public class HttpClientUtil {
	 ...
	 * throws IOException { URL url = new URL(strUrl); HttpsURLConnection
	 * httpsURLConnection = (HttpsURLConnection) url .openConnection(); return
	 * httpsURLConnection; }
	 */
	...
	public static String getVendorX509() {
		...
		if (!HttpClientUtil.isVendor(HttpClientUtil.getVmVendor(), "sun")
				&& !HttpClientUtil.isVendor(HttpClientUtil.getVmVendor(), "oracle")) {
	...
	public static void main(String[] args) {
		System.out.println(HttpClientUtil.isVendor(HttpClientUtil.getVmVendor(), "ibm"));
		System.out.println(HttpClientUtil.getVendorX509());
	}
