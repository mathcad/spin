...
public class DirectiveUtils {
	...
	public static String getRequiredParam(@SuppressWarnings("rawtypes") Map params, String key)
	...
	public static String getParam(@SuppressWarnings("rawtypes") Map params, String key, String defaultValue)
			throws TemplateException {
		Object value = params.get(key);
	...
	public static TemplateDirectiveBodyOverrideWraper getDefineBody(Environment env, String name)
			throws TemplateModelException {
		TemplateDirectiveBodyOverrideWraper value = (TemplateDirectiveBodyOverrideWraper) env
				.getVariable(DirectiveUtils.getDefineVariableName(name));
		return value;
	}

	public static void setTopBodyForParentBody(Environment env, TemplateDirectiveBodyOverrideWraper topBody,
