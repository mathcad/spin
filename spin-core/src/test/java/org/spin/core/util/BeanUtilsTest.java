...
class BeanUtilsTest {
    ...
    @Test
    void getFieldValue() {
        List<Map<String, Object>> maps = CollectionUtils.ofArrayList(MapUtils.ofMap("detail", "aaaaa", "no", 255, "demo", new DemoA()),
        ...
        map = BeanUtils.setFieldValue(map, "parent.address[0].demo.name", "name");
