 ...
 * @author xuweinan
 */
public class Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> implements
    Tuple<Tuple14<N, M, L, K, J, I, H, G, F, E, D, C, B, A>> {
    private static final long serialVersionUID = 8423461793890418409L;
    ...
    private Tuple14(final A c1, final B c2, final C c3, final D c4,
    ...
    Tuple14<A, B, C, D, E, F, G, H, I, J, K, L,
        M, N> of(final A c1, final B c2, final C c3, final D c4,
                 ...
                 final I c9, final J c10, final K c11, final L c12,
                 final M c13, final N c14) {
        return new Tuple14<>(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14);
    }
    ...
    public <E1> E1 get(int pos) {
        switch (pos) {
            ...
            case 13:
                return (E1) c14;
            default:
                throw new IndexOutOfBoundsException("索引超出范围[0, 13]，实际:" + pos);
        }
    }
    ...
    public Tuple14<N, M, L, K, J, I, H, G, F, E, D, C, B, A> reverse() {
        return of(c14, c13, c12, c11, c10, c9, c8, c7, c6, c5, c4, c3, c2, c1);
    }
