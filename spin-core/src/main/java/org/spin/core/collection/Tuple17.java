 ...
 * @author xuweinan
 */
public class Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> implements
    Tuple<Tuple17<Q, P, O, N, M, L, K, J, I, H, G, F, E, D, C, B, A>> {
    private static final long serialVersionUID = 5143102935181966790L;
    ...
    private Tuple17(final A c1, final B c2, final C c3, final D c4,
    ...
    Tuple17<A, B, C, D, E, F, G, H, I, J, K, L,
        M, N, O, P, Q> of(final A c1, final B c2, final C c3, final D c4,
                          ...
                          final M c13, final N c14, final O c15, final P c16,
                          final Q c17) {
        return new Tuple17<>(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17);
    }

    @Override
    public Object[] toArray() {
        return CollectionUtils.ofArray(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17);
    }
    ...
    public <E1> E1 get(int pos) {
        switch (pos) {
            ...
            case 16:
                return (E1) c17;
            default:
                throw new IndexOutOfBoundsException("索引超出范围[0, 16]，实际:" + pos);
        }
    }
    ...
    public Tuple17<Q, P, O, N, M, L, K, J, I, H, G, F, E, D, C, B, A> reverse() {
        return of(c17, c16, c15, c14, c13, c12, c11, c10, c9, c8, c7, c6, c5, c4, c3, c2, c1);
    }
