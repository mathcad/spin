 ...
 * its <code>maximum weighted capacity</code> threshold. A {@link Weigher}
...
public final class ConcurrentLinkedHashMap<K, V> extends AbstractMap<K, V>
    ...
    V put(K key, V value, boolean onlyIfAbsent) {
        ...
        final int weight = weigher.weightOfEntry(key, value);
    ...
    public boolean replace(K key, V oldValue, V newValue) {
        ...
        final int weight = weigher.weightOfEntry(key, newValue);
    ...
    Set<K> orderedKeySet(boolean ascending, int limit) {
        ...
        try {
            ...
            final int initialCapacity = (weigher == Weighers.singleton())
     ...
     */
    static final class BoundedEntryWeigher<V> implements Weigher<V>, Serializable {
        static final long serialVersionUID = 1;
        final Weigher<? super V> weigher;

        BoundedEntryWeigher(Weigher<? super V> weigher) {
        ...
        @Override
        public <K> int weightOfEntry(K key, V value) {
            int weight = weigher.weightOfEntry(key, value);
            checkArgument(weight >= 1);
            return weight;
        }
    ...
    public static final class Builder<K, V> {
         ...
         *
         * @return ConcurrentLinkedHashMap instance
