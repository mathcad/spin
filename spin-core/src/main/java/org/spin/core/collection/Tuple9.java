 ...
 * @author xuweinan
 */
public class Tuple9<A, B, C, D, E, F, G, H, I> implements Tuple<Tuple9<I, H, G, F, E, D, C, B, A>> {
    ...
    private Tuple9(final A c1, final B c2, final C c3, final D c4, final E c5, final F c6, final G c7, final H c8, final I c9) {
        this.c1 = c1;
        this.c2 = c2;
        this.c3 = c3;
        this.c4 = c4;
    ...
    public static <A, B, C, D, E, F, G, H, I> Tuple9<A, B, C, D, E, F, G, H, I> of(final A c1, final B c2, final C c3, final D c4, final E c5, final F c6, final G c7, final H c8, final I c9) {
        return new Tuple9<>(c1, c2, c3, c4, c5, c6, c7, c8, c9);
    }

    @Override
    public Object[] toArray() {
        return CollectionUtils.ofArray(c1, c2, c3, c4, c5, c6, c7, c8, c9);
    }
    ...
    public <E1> E1 get(int pos) {
        switch (pos) {
            ...
            case 8:
                return (E1) c9;
            default:
                throw new IndexOutOfBoundsException("索引超出范围[0, 8]，实际:" + pos);
        }
    }
