 ...
 * @author xuweinan
 */
public class Tuple7<A, B, C, D, E, F, G> implements Tuple<Tuple7<G, F, E, D, C, B, A>> {
    private static final long serialVersionUID = -2664478916392915157L;
    ...
    private Tuple7(final A c1, final B c2, final C c3, final D c4, final E c5, final F c6, final G c7) {
        this.c1 = c1;
        this.c2 = c2;
        this.c3 = c3;
        this.c4 = c4;
    ...
    public static <A, B, C, D, E, F, G> Tuple7<A, B, C, D, E, F, G> of(final A c1, final B c2, final C c3, final D c4, final E c5, final F c6, final G c7) {
        return new Tuple7<>(c1, c2, c3, c4, c5, c6, c7);
    }

    @Override
    public Object[] toArray() {
        return CollectionUtils.ofArray(c1, c2, c3, c4, c5, c6, c7);
    }
