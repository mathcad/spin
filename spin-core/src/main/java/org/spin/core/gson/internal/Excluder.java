...
import org.spin.core.gson.ExclusionStrategy;
import org.spin.core.gson.FieldAttributes;
...
import org.spin.core.gson.annotation.Until;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public boolean excludeField(Field field, boolean serialize) {
        ...
        if (requireExpose && null == annotation) {
            return true;
        }
