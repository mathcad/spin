...
public class Platform extends UserAgentInfo {
     ...
     * 支持的移动平台类型
     */
    public static final List<Platform> mobilePlatforms = CollectionUtils.ofArrayList(//
     ...
     * 支持的桌面平台类型
     */
    public static final List<Platform> desktopPlatforms = CollectionUtils.ofArrayList(//
