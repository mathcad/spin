...
public class SpinRibbonClientConfiguration {
    ...
    public RibbonClientSpecification spinSpecification() {
        return new RibbonClientSpecification("default.org.spin.common.config.SpinRibbonClientConfiguration", CollectionUtils.ofArray(SpinRibbonClientConfiguration.class));
    }
